    ...
    <div className={` bg-darkGrey  gap-5 md:gap-10 lg:gap-16 xl:gap-24  w-full flex flex-col  justify-center items-center min-h-[50vh] h-auto ${pagePadding}`}>
      ...
      viewport={{ once: true, amount: 0.2 }}
            className='relative py-5'>
                <PhotoCard image='/img1.jpg' style='absolute z-10 -left-28 sm:-left-40 md:-left-60 bottom-0 -rotate-[15deg]' />
                <PhotoCard image='/img2.jpg' style='absolute z-10 -right-28 sm:-right-40 md:-right-60 bottom-0 rotate-[15deg]' />
                <PhotoCard image='/img3.jpg' style='mb-10' />
            </motion.div>
